                ...
                <div id="main" className="md:grid grid-cols-3 w-full flex justify-center items-center flex-col">
                    ...
                    <div className='text-white flex justify-center items-center flex-col px-5'>
                        ...
                        <div className='flex mt-10 w-full bg-white rounded-2xl '>
                            <input type="text" onChange={(e) => setSearchKey(e.target.value)} placeholder='Search Books'
                             className='py-2 px-4 bg-white rounded-3xl text-black placeholder-gray-500 w-full' />
                            <FontAwesomeIcon icon={faMagnifyingGlass} className='text-blue-800 me-2'
